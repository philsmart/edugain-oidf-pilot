...
| **TA-03** | Hierarchical Multi-Intermediate | A single Trust Anchor with two intermediate authorities; each intermediate manages its own OP and RP. |
